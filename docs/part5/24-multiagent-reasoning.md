...
- **核心心智模型（面对聪明人的博弈）**：在单智能体环境里，自然界没有自己的小心思；但在多智能体系统里，你的对手同样在试图揣摩你的心思。
- **纳什均衡不是“皆大欢喜”，而是“谁都不敢轻举妄动”**：
  - 纳什均衡状态下，**在对手不改主意的前提下，你自己单方面改任何主意只会让自己收益更低或不变**；
  - 它是一种自我锁定的战略死结（例如囚徒困境中双方明知合作更好，却被迫死锁在双重背叛的纳什均衡中）。
- **认知层级（Level-$k$ 思考模型）**：现实中人并非无限理性：
  - Level 0 纯粹瞎玩（均匀随机出招）；
  - Level 1 假设对手是傻子（针对 Level 0 做最优反应）；
  - Level 2 预判了 Level 1 的预判；
  - 这种分层模型精准解释了为什么高水平玩家在面对新手时偶尔会被对方不按常理出牌的乱拳打死。
:::
---
